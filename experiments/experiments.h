...
void experiment_read_raw(struct io_uring* ring, int fd);

void experiment_read_file_direct(struct io_uring* ring, int fd);
void experiment_read_raw_direct(struct io_uring* ring, int fd);

void experiment_read_file_direct_noncpy(struct io_uring* ring, int fd);
void experiment_read_raw_direct_noncpy(struct io_uring* ring, int fd);
